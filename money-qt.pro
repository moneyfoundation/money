...
contains(MONEY_NEED_QT_PLUGINS, 1) {
    DEFINES += MONEY_NEED_QT_PLUGINS
...
HEADERS += src/qt/moneygui.h \
    ...
    src/qt/moneyaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/money.cpp \
    ...
    src/qt/moneyaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/moneystrings.cpp \
    src/qt/moneyamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
contains(MONEY_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = money-qt_test
DEFINES += MONEY_QT_TEST
...
# also add new translations to src/qt/money.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/money_*.ts)
...
win32:RC_FILE = src/qt/res/money-qt.rc
...
macx:ICON = src/qt/res/icons/money.icns
