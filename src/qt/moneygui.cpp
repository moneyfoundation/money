 ...
 * The Money Developers 2011-2012
 */
...
const QString MoneyGUI::DEFAULT_WALLET = "~Default";

MoneyGUI::MoneyGUI(bool fIsTestnet, QWidget *parent) :
    QMainWindow(parent),
    ...
    prevBlocks(0)
{
    ...
    if (!fIsTestnet)
    {
        setWindowTitle(tr("Money") + " - " + tr("Wallet"));
        QApplication::setWindowIcon(QIcon(":icons/money"));
        setWindowIcon(QIcon(":icons/money"));
    }
    else
    {
        setWindowTitle(tr("Money") + " - " + tr("Wallet") + " " + tr("[testnet]"));
        QApplication::setWindowIcon(QIcon(":icons/money_testnet"));
        setWindowIcon(QIcon(":icons/money_testnet"));
    }
#else
    ...
    if (!fIsTestnet)
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/money"));
    else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/money_testnet"));
#endif
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void MoneyGUI::RunMiningAsStartup()
{
...
void MoneyGUI::SetMiningStatus(bool isMining)
{
    //if(ui->checkBox)
...
void MoneyGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Money address"));
  ...
  //  connect(ui->bNewMessage, SIGNAL(clicked()), this, SLOT(showNormalIfMinimized()));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/money"), tr("&About Money"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/money_testnet"), tr("&About Money"), this);
    aboutAction->setStatusTip(tr("Show information about Money"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Money"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/money"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/money_testnet"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Money addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Money addresses"));
...
void MoneyGUI::setClientModel(ClientModel *clientModel)
{
...
void MoneyGUI::setWalletModel(WalletModel *walletModel)
{
...
void MoneyGUI::createTrayIcon()
{
#ifndef Q_OS_MAC
    trayIcon = new QSystemTrayIcon(this);

    trayIcon->setToolTip(tr("Money client"));
...
void MoneyGUI::createTrayIconMenu()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void MoneyGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void MoneyGUI::saveWindowGeometry()
{
    QSettings settings;
...
void MoneyGUI::restoreWindowGeometry()
{
    QSettings settings;
...
void MoneyGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Money network", "", count));
}

void MoneyGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
		...
		labelWorldIcon->setPixmap(QPixmap(":/res/money_icon_on.png"));
    ...
    labelWorldIcon->setToolTip(tooltip);
    progressBarLabel->setToolTip(tooltip);
    progressBar->setToolTip(tooltip);
}

void MoneyGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    QString strTitle = tr("Money"); // default title
...
void MoneyGUI::changeEvent(QEvent *e)
{
...
void MoneyGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void MoneyGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        "which goes to the nodes that process your transaction and helps to support the network. "
        "Do you want to pay the fee?").arg(MoneyUnits::formatWithUnit(MoneyUnits::WDC, nFeeRequired));
...
//void MoneyGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
void MoneyGUI::incomingTransaction(const QModelIndex& parent, int start, int /*end*/)
{
    ...
    message((amount)<0 ? tr("Sent transaction") : tr("Incoming transaction"),
             tr("Date: %1\n"
                ...
                "Address: %4\n")
                  .arg(date)
                  .arg(MoneyUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                  .arg(type)
                  .arg(address), CClientUIInterface::MSG_INFORMATION);
}

void MoneyGUI::gotoOverviewPage()
{
...
void MoneyGUI::gotoAddressBookPage()
{
...
void MoneyGUI::gotoReceiveCoinsPage()
{
...
//void MoneyGUI::gotoSendCoinsPage(QString addr)
void MoneyGUI::gotoSendCoinsPage()
{
...
void MoneyGUI::gotoSignMessageTab(QString addr)
{
...
void MoneyGUI::gotoVerifyMessageTab(QString addr)
{
...
void MoneyGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void MoneyGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
	    ...
	    gotoSendCoinsPage();
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Money address or malformed URI parameters."),
...
bool MoneyGUI::eventFilter(QObject *object, QEvent *event)
{
...
void MoneyGUI::resizeEvent(QResizeEvent *e)
{
    updateMask();
    QMainWindow::resizeEvent(e);
}

void MoneyGUI::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
...
void MoneyGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void MoneyGUI::menuFileRequested()
{
    QMenu menu(this);
...
void MoneyGUI::menuOperationsRequested()
{
    QMenu menu(this);
    QAction* send = menu.addAction(tr("Send Moneys"));
    QAction* receive = menu.addAction(tr("Receive Moneys"));
...
void MoneyGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void MoneyGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void MoneyGUI::changePassphrase()
{
...
void MoneyGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void MoneyGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void MoneyGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void MoneyGUI::onMiningClicked()
{
    //ui->wMining->setStyleSheet("background-color:black;");
    centralWidget->setCurrentWidget(miningPage);
}

void MoneyGUI::on_bHelp_clicked()
{    
    rpcConsole->show();
}
