...
/**
  Money GUI main class. This class represents the main window of the Money UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MoneyGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MoneyGUI(bool fIsTestnet = false, QWidget *parent = 0);
    ~MoneyGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a money wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
