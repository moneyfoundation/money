...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Money " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	 {"dns.yourmoneyknowledge.com", "dns.yourmoneyknowledge.com"},
	 {"moneydns.twilightparadox.com", "moneydns.twilightparadox.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Money is probably already running."), addrBind.ToString().c_str());
        else
